...
import { RegisterCNABTransactionsUsecase } from "../register-transactions-data"

describe('Register transactions data from CNAB data', () => {
  ...
  it('should be able to create new CNAB transactions successfully', async () => {
    ...
    const transaction = new RegisterCNABTransactionsUsecase(transactionsRepository)

    const response = await transaction.execute(mockedCNABData)
